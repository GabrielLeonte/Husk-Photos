  ...
  <div>
    <div class="image">
      ...
      <span class="photo-data">
        Manhattan, New York, United States by Malte Schmidt <br />
        on December 9, 2017
      </span>
    </div>
    <div class="b-50">
      <div class="cbox">
        ...
        <div class="c-inputs">
          ...
          <div class="base">
            <span class="small-text-center">Don't have an account?</span>
            <nuxt-link class="small-text-center" to="/signup">
              Make one
            </nuxt-link>
          </div>
        </div>
